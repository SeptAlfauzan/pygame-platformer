...
class Player:
    ...
    def __init__(self):
        ...
        self.coll_rect = pygame.Rect(self.position[0], self.position[1], 16 #subtract with 30, so the collision box's width of player can move 30px to left (so it fit the pixel)
